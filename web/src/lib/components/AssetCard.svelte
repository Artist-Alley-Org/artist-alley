<script lang="ts">
  ...
  function isVideo(ext: string | null | undefined): boolean {
    if (!ext) return false;
  ...
  // PostCard). The sprite sheet is generated by preview.video; one
  // content-addressed image gives ~100 frames of scrub.
