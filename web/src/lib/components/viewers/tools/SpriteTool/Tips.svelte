...
<script lang="ts">
  // Sprite-tool Tips — extracted verbatim from the SpriteToolPanel
  // footer that's now retired. Renders <dt>/<dd> pairs as direct
  // children of the shell's TipsSection <dl> grid.
