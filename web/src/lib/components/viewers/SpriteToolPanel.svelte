...
<div class="flex h-full min-h-0 flex-col text-fg">
  ...
  <div class="min-h-0 flex-1 overflow-y-auto">
    ...
    <!-- Tips section retired — the ToolPanelShell renders the
         SpriteTool's Tips component into its global TipsSection
         footer. Keeping the panel body focused on tool sections
         only; chrome is the shell's job. -->
  </div>
</div>
