...
GAPS: list[GapAsset] = [
    ...
    # library of its best video. These come straight from the Foundation,
    # so the catalogue no longer has a single point of failure for the
    ...
    GapAsset(
        ...
        asset_type="video",
        notes="Full 15-min film in MKV — exercises long-form playback + a container the trailer doesn't",
    ),
    GapAsset(
        ...
        source="Blender Foundation",
        asset_type="video",
        notes="Live-action/VFX short in QuickTime — direct Blender mirror, replaces the 503-ing archive.org copy",
    ),
    GapAsset(
