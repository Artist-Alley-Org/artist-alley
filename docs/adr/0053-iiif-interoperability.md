...
- **1.54.D** (#193) — Mirador dogfood proof: operator step, not a code phase. Unblocked by 1.54.C. Priority: high — deferred through both 1.54.B and 1.54.C, no more shipping IIIF-arc code work until this is confirmed.
