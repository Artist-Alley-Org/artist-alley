...
func TestUnmarshalPreferencesRow_EmptyBytesProduceZero(t *testing.T) {
	p, err := UnmarshalPreferencesRow(nil, nil, nil, nil, nil)
	if err != nil {
...
func TestUnmarshalPreferencesRow_RoundTrip(t *testing.T) {
	...
	got, err := UnmarshalPreferencesRow(channelsJSON, viewsJSON, nil, nil, nil)
	if err != nil {
...
func TestUnmarshalPreferencesRow_DropsStaleViewValues(t *testing.T) {
	...
	got, err := UnmarshalPreferencesRow(nil, legacy, nil, nil, nil)
	if err != nil {
