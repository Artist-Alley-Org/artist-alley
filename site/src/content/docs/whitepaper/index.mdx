...
The federation protocol — **[ArchivePub](/protocol/archivepub/)** — is open, ActivityPub-shaped, and implementable by anyone. We're shipping the reference implementation because no other DAM, open-source or commercial, was going to. Federation between studios shouldn't be a feature you rent from a SaaS vendor; it should be a property of the protocol.
